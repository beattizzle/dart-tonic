...
void main() {
  ...
  group('Pitch', () {
    ...
    test('- Pitch should return an Interval', () {
      ...
      // negative intervals
      expect(Pitch.parse('C4') - Pitch.parse('D♭4'), Interval.M7);
      expect(Pitch.parse('C4') - Pitch.parse('D♭5'), Interval.M7);
      expect(Pitch.parse('C4') - Pitch.parse('D4'), Interval.m7);
      expect(Pitch.parse('C4') - Pitch.parse('D5'), Interval.m7);
      expect(Pitch.parse('C4') - Pitch.parse('D#4'), Interval.M6);
      expect(Pitch.parse('C4') - Pitch.parse('D#5'), Interval.M6);
      expect(Pitch.parse('C4') - Pitch.parse('E4'), Interval.m6);
      expect(Pitch.parse('C4') - Pitch.parse('E5'), Interval.m6);
      expect(Pitch.parse('C4') - Pitch.parse('F4'), Interval.P5);
      expect(Pitch.parse('C4') - Pitch.parse('F5'), Interval.P5);
      expect(Pitch.parse('C4') - Pitch.parse('F#4'), Interval.d5);
      expect(Pitch.parse('C4') - Pitch.parse('F#5'), Interval.d5);
      expect(Pitch.parse('C3') - Pitch.parse('G3'), Interval.P4);
      expect(Pitch.parse('C3') - Pitch.parse('G4'), Interval.P4);
      expect(Pitch.parse('C3') - Pitch.parse('G#3'), Interval.M3);
      expect(Pitch.parse('C3') - Pitch.parse('G#4'), Interval.M3);
      expect(Pitch.parse('C3') - Pitch.parse('A3'), Interval.m3);
      expect(Pitch.parse('C3') - Pitch.parse('A4'), Interval.m3);
      expect(Pitch.parse('C3') - Pitch.parse('A#3'), Interval.M2);
      expect(Pitch.parse('C3') - Pitch.parse('A#4'), Interval.M2);
      expect(Pitch.parse('C3') - Pitch.parse('B3'), Interval.m2);
      expect(Pitch.parse('C3') - Pitch.parse('B4'), Interval.m2);
    });
  });
}
